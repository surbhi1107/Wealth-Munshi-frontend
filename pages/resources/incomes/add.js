...
export default function AddIncomes(props) {
  ...
  const getGoalData = async (owner, default_start, default_end) => {
    setLoading(true);
...
export const getServerSideProps = async (ctx) => {
  ...
  return { props: { state: income_type, user: user } };
};
