...
const Input = ({
  ...
  return (
    <div className={`w-full space-y-1 ${mainClass}`}>
      ...
      <div className="relative px-[1px] mt-1">
        <input
          onChange={onchange}
          id={id}
          value={value}
          ...
          className={`w-full rounded border-0 ring-[0.5px] ring-[#CBCAD7] text-[#686677] bg-transparent px-2 py-2 text-base font-normal text-blue-gray-700 outline-0 focus:!ring-2 focus:ring-[#A9A6CF] focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50 ${inputClass}`}
          {...props}
        />
        {isPassword ? (
